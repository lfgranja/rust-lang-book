...
- [Enums e Casamento de Padrões (Pattern Matching)](ch06-00-enums.md)
...
- [Tratamento de Erros](ch09-00-error-handling.md)
  ...
  - [Entrar em Pânico ou Não?](ch09-03-to-panic-or-not-to-panic.md)
...
- [Um Projeto de E/S: Construindo um Programa de Linha de Comando](ch12-00-an-io-project.md)
  ...
  - [Desenvolvendo Funcionalidades com Test Driven Development (TDD)](ch12-04-testing-the-librarys-functionality.md)
  - [Trabalhando com Variáveis de Ambiente](ch12-05-working-with-environment-variables.md)
  - [Escrevendo em stderr em vez de stdout](ch12-06-writing-to-stderr-instead-of-stdout.md)
...
- [Ponteiros Inteligentes (Smart Pointers)](ch15-00-smart-pointers.md)
  ...
  - [Tratando Smart Pointers como Referências Regulares](ch15-02-deref.md)
  - [Executando Código na Limpeza com a Trait `Drop`](ch15-03-drop.md)
  - [`Rc<T>`, o Smart Pointer com Contagem de Referência](ch15-04-rc.md)
...
- [Concorrência Destemida](ch16-00-concurrency.md)
  - [Usando Threads para Executar Código Simultaneamente](ch16-01-threads.md)
  - [Transferindo Dados Entre Threads com Troca de Mensagens](ch16-02-message-passing.md)
...
- [Fundamentos da Programação Assíncrona: Async, Await, Futures e Streams](ch17-00-async-await.md)
  ...
  - [Um Olhar Mais Atento às Traits para Async](ch17-05-traits-for-async.md)
...
- [Projeto Final: Construindo um Servidor Web Multithread](ch21-00-final-project-a-web-server.md)
  ...
  - [De Single-Threaded para Servidor Multithreaded](ch21-02-multithreaded.md)
